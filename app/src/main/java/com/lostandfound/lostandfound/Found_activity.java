...
public class Found_activity extends AppCompatActivity implements ItemClickListener, OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appbar_bottom.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem arg0) {
                ...
                if (arg0.getItemId() == R.id.action_Nearby) {
                    Intent i = new Intent(Found_activity.this, Nearby.class);
                    i.putExtra("TAG","Found");
                    startActivity(i);
        ...
        fab1dialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                builder = new AlertDialog.Builder(Found_activity.this);
                // Get the layout inflater
                LayoutInflater inflater = Found_activity.this.getLayoutInflater();
                ...
                Dialoglost.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(Found_activity.this, Form_page.class);
                ...
                DialogScanQR.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(Found_activity.this, Qrcode_main.class);
                        startActivity(i);
                        alert11.dismiss();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Found) {
            Intent i = new Intent(Found_activity.this, Found_activity.class);
            startActivity(i);

        } else if (id == R.id.nav_Lost) {
            Intent i = new Intent(Found_activity.this, Lost_activity.class);
            startActivity(i);

        } else if (id == R.id.nav_profile) {
            Intent i = new Intent(Found_activity.this, UserProfile.class);
            startActivity(i);
            ...
            auth.signOut();
            Intent i = new Intent(Found_activity.this, Login.class);
            startActivity(i);
            finish();
        ...
        */
        ...
        mAdapter.setOnItemClickListener(new CardViewAdapter.ClickListener() {
            ...
            public void onItemClick(int position, View v) {
                myRef.child("Objects Found").child(ObjectID.get(position)).child("views").setValue(Views.get(position)+1);

                // Toast.makeText(getApplicationContext(), "Thank You!", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(Found_activity.this, Open_card_layout_item.class);
